                        ...
                        <td class="actions-cell">
                            ...
                            @auth
                                @if(Auth::user()->isAdmin())
                                    ...
                                    <button class="btn-action btn-delete btn-delete-item" onclick="eliminarHoja({{ $sheet->id }}, '{{ addslashes($sheet->title) }}')" title="Eliminar hoja" style="display:none;">🗑️</button>
                                @endif
                            @endauth
                        </td>
                    </tr>
