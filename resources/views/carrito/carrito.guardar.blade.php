...
<div id="modal-guardar-hoja" class="modal-hoja" style="display: none;">
    <div class="modal-hoja-content">
        ...
        <div class="modal-hoja-footer">
            <button type="button" class="btn-download btn-cancel" onclick="cerrarModalHoja()">Cancelar</button>
            <button type="button" class="btn-download" onclick="guardarHoja()">Guardar</button>
        </div>
    </div>
</div>

<style>
/* Acciones del carrito - hojas */
.carrito-actions {
    display: flex;
    gap: 1rem;
